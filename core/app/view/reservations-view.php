...
<a href="./index.php?view=newreservation" class="btn btn-info">Nova Consulta</a>
<a href="./index.php?view=oldreservations" class="btn btn-default">Consultas Anteriores</a>
<br><br>
	...
	$sql .= " date_at = \"".$_GET["date_at"]."\"";
		...
		if(count($users)>0){
			...
			foreach($users as $user){
				...
				<a href="index.php?action=delreservation&id=<?php echo $user->id;?>" class="btn btn-danger btn-xs">Excluir</a>
				</td>
				</tr>
				<?php
