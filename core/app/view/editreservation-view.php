...
<option value="">-- SELECIONE --</option>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Estado da consulta</label>
    <div class="col-lg-4">
<select name="status_id" class="form-control" required>
  ...
  <?php endforeach; ?>
    ...
    <label for="inputEmail1" class="col-lg-2 control-label">Estado de pagamento</label>
    <div class="col-lg-4">
...
<div class="input-group">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="id" value="<?php echo $reservation->id; ?>">
      <button type="submit" class="btn btn-default">Atualizar Consulta</button>
    </div>
  </div>
</form>
</div>
